...
from enhanced_ecosystem_with_psi_and_frequency import EnhancedHumanQuantumEcosystem
...
class QuantumReactor(EnhancedHumanQuantumEcosystem):
    def __init__(self, num_particles=1000, subspace_dimensions=11, interaction_strength=0.1, base_frequency=1e15):
        super().__init__(num_groups=subspace_dimensions, interaction_strength=interaction_strength, base_frequency=base_frequency)
